...
JNIEXPORT void JNICALL Java_jse_cptr_NestedDoubleCPointer_fill1(JNIEnv *aEnv, jclass aClazz, jlong rPtr, jdouble aValue, jint aRowNum, jint aColNum) {
...
JNIEXPORT jdouble JNICALL Java_jse_cptr_NestedDoubleCPointer_getAt_1(JNIEnv *aEnv, jclass aClazz, jlong aPtr, jint aRowNum, jint aColNum) {
    return (jdouble) ((double **)(intptr_t)aPtr)[aRowNum][aColNum];
}
JNIEXPORT void JNICALL Java_jse_cptr_NestedDoubleCPointer_putAt_1(JNIEnv *aEnv, jclass aClazz, jlong aPtr, jint aRowNum, jint aColNum, jdouble aValue) {
