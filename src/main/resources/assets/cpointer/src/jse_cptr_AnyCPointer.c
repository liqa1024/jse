...
JNIEXPORT jlong JNICALL Java_jse_cptr_AnyCPointer_typeSize_1(JNIEnv *aEnv, jclass aClazz) {
...
JNIEXPORT jlong JNICALL Java_jse_cptr_AnyCPointer_getAt_1(JNIEnv *aEnv, jclass aClazz, jlong aPtr, jlong aIdx) {
...
JNIEXPORT void JNICALL Java_jse_cptr_AnyCPointer_putAt_1(JNIEnv *aEnv, jclass aClazz, jlong aPtr, jlong aIdx, jlong aValue) {
...
JNIEXPORT jlong JNICALL Java_jse_cptr_AnyCPointer_rightShift_1(JNIEnv *aEnv, jclass aClazz, jlong aPtr, jlong aCount) {
    void **tPtr = (void **)(intptr_t)aPtr;
    tPtr += aCount;
    return (jlong)(intptr_t)tPtr;
}
...
JNIEXPORT jlong JNICALL Java_jse_cptr_AnyCPointer_leftShift_1(JNIEnv *aEnv, jclass aClazz, jlong aPtr, jlong aCount) {
    void **tPtr = (void **)(intptr_t)aPtr;
    tPtr -= aCount;
    return (jlong)(intptr_t)tPtr;
}
