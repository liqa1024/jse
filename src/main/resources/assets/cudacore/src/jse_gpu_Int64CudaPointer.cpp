...
JNIEXPORT void JNICALL Java_jse_gpu_Int64CudaPointer_fill_1(JNIEnv *aEnv, jclass aClazz, jlong rPtr, jlongArray aJArray, jint aStart, jint aCount) {
...
JNIEXPORT void JNICALL Java_jse_gpu_Int64CudaPointer_parse2dest_1(JNIEnv *aEnv, jclass aClazz, jlong aPtr, jlongArray rJArray, jint aStart, jint aCount) {
    int64_t *tBuf = MALLOCN_TP(int64_t, aCount);
