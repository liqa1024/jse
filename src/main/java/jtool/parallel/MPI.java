...
public class MPI {
    ...
    public static class Native {
        ...
        public static <S, R> void MPI_Allgatherv(S aSendBuf, int aSendCount, R rRecvBuf, int[] aRecvCounts, int[] aDispls, long aComm) {
            MPI_Allgatherv0(aSendBuf, aSendCount, datatypeOf_(aSendBuf), rRecvBuf, aRecvCounts, aDispls, datatypeOf_(rRecvBuf), aComm);
        }
        private native static void MPI_Allgatherv0(Object aSendBuf, int aSendCount, long aSendType, Object rRecvBuf, int[] aRecvCounts, int[] aDispls, long aRecvType, long aComm);
        ...
        public static <T> void MPI_Allreduce(T aSendBuf, T rRecvBuf, int aCount, long aOp, long aComm) {
            MPI_Allreduce0(aSendBuf, rRecvBuf, aCount, datatypeOf_(aSendBuf), aOp, aComm);
        }
        private native static void MPI_Allreduce0(Object aSendBuf, Object rRecvBuf, int aCount, long aDataType, long aOp, long aComm);
        ...
        public static <S, R> void MPI_Gather(S aSendBuf, int aSendCount, R rRecvBuf, int aRecvCount, int aRoot, long aComm) {
            MPI_Gather0(aSendBuf, aSendCount, datatypeOf_(aSendBuf), rRecvBuf, aRecvCount, datatypeOf_(rRecvBuf), aRoot, aComm);
        }
        private native static void MPI_Gather0(Object aSendBuf, int aSendCount, long aSendType, Object rRecvBuf, int aRecvCount, long aRecvType, int aRoot, long aComm);
        ...
        public static <S, R> void MPI_Gatherv(S aSendBuf, int aSendCount, R rRecvBuf, int[] aRecvCounts, int[] aDispls, int aRoot, long aComm) {
            MPI_Gatherv0(aSendBuf, aSendCount, datatypeOf_(aSendBuf), rRecvBuf, aRecvCounts, aDispls, datatypeOf_(rRecvBuf), aRoot, aComm);
        }
        private native static void MPI_Gatherv0(Object aSendBuf, int aSendCount, long aSendType, Object rRecvBuf, int[] aRecvCounts, int[] aDispls, long aRecvType, int aRoot, long aComm);
        ...
        public static <T> void MPI_Reduce(T aSendBuf, T rRecvBuf, int aCount, long aOp, int aRoot, long aComm) {
            MPI_Reduce0(aSendBuf, rRecvBuf, aCount, datatypeOf_(aSendBuf), aOp, aRoot, aComm);
        }
        private native static void MPI_Reduce0(Object aSendBuf, Object rRecvBuf, int aCount, long aDataType, long aOp, int aRoot, long aComm);
