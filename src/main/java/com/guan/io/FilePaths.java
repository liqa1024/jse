...
public class FilePaths {
    public static List<String> get(final String aFilePath) {return get(aFilePath, 0, -1);}
    public static List<String> get(final String aFilePath, final int aMultiple) {return get(aFilePath, 0, aMultiple);}
