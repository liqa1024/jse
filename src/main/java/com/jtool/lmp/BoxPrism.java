...
public class BoxPrism extends Box {
    ...
    public BoxPrism(@NotNull XYZ aBox, double aXY, double aXZ, double aYZ) {super(aBox); mXY = aXY; mXZ = aXZ; mYZ = aYZ;}
    public BoxPrism(@NotNull XYZ aBoxLo, @NotNull XYZ aBoxHi, double aXY, double aXZ, double aYZ) {super(aBoxLo, aBoxHi); mXY = aXY; mXZ = aXZ; mYZ = aYZ;}
