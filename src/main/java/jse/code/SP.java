...
//                .mimetype("text/x-groovy")
    ...
    public static class Python {
        ...
        static {
            ...
            // 通过上述属性决定使用的 jep 路径
            JEP_LIB_DIR = JAR_DIR+"jep/" + UT.Code.uniqueID(OS.OS_NAME, JAVA_HOME, VERSION, PYTHON_PREFIX_DIR, JEP_VERSION, NUMPY_SUPPORT, Conf.USE_MIMALLOC, Conf.CMAKE_C_COMPILER, Conf.CMAKE_C_FLAGS, Conf.CMAKE_SETTING) + "/";
