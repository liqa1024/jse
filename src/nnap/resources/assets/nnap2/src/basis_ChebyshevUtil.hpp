...
static NNAP_DEVICE void gradFpEx2xyz(int j, flt_t *aGradFpEx, flt_t *aGradFp, flt_t *aRnpGrad,
                                     flt_t aDx, flt_t aDy, flt_t aDz, flt_t *rGradNlDx, flt_t *rGradNlDy, flt_t *rGradNlDz) noexcept {
