...
JSE_PLUGINEXPORT int JSE_PLUGINCALL jse_nnap_cuda2lammps(void *aDataIn, void *rDataOut) {
    ...
    JSE_NNAP::flt_t *fltBuf = (JSE_NNAP::flt_t *)tDataOut[0];
    JSE_NNAP::flt_t *cudaF = (JSE_NNAP::flt_t *)tDataOut[3];
    JSE_NNAP::flt_t *cudaEV = (JSE_NNAP::flt_t *)tDataOut[4];
    JSE_NNAP::flt_t *cudaEatom = (JSE_NNAP::flt_t *)tDataOut[5];
    JSE_NNAP::flt_t *cudaVatom = (JSE_NNAP::flt_t *)tDataOut[6];
