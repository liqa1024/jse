...
public class SimpleSphericalChebyshev extends Basis {
    ...
    SimpleSphericalChebyshev(String @Nullable[] aSymbols, int aTypeNum, int aNMax, int aLMax, int aL3Max, double aRCut,  @Nullable Vector aRFuncScale, @Nullable Vector aRFuncShift, @Nullable Vector aWtScale, double @Nullable[] aNnScale, boolean aPolyScale) {
        this(aSymbols, aTypeNum, aNMax, aLMax, Math.max(aLMax, aL3Max), aL3Max, aRCut, aRFuncScale, aRFuncShift, aWtScale, aNnScale, aPolyScale);
    }
    /**
    ...
    public SimpleSphericalChebyshev(String @NotNull[] aSymbols, int aNMax, int aLMax, double aRCut) {
        this(aSymbols, aSymbols.length, aNMax, aLMax, SphericalChebyshev.DEFAULT_L3MAX, aRCut, null, null, null, null, false);
    }
    /**
    ...
    public SimpleSphericalChebyshev(int aTypeNum, int aNMax, int aLMax, double aRCut) {
        this(null, aTypeNum, aNMax, aLMax, SphericalChebyshev.DEFAULT_L3MAX, aRCut, null, null, null, null, false);
    }
    
    @Override public SimpleSphericalChebyshev threadSafeRef() {
        return new SimpleSphericalChebyshev(mSymbols, mTypeNum, mNMax, mLMax, mL3Max, mRCut, mRFuncScale, mRFuncShift, mWtScale, mNnScale, mPolyScale);
    }
    ...
    void calL3_(DoubleArrayVector aCnlm, IVector rFp) {
        ...
        if (mPolyScale) rFp3 = SQRT_PI4*MathEX.Fast.cbrt(rFp3);
        rFp.set(0, rFp3);
        /// l1 = l2 = 1, l3 = 2
