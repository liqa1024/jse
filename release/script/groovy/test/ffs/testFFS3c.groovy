...
.doJob {
    ...
    def plt = Plotters.get();
    plt.semilogy(lambda, k1    , 'all'      );
    plt.semilogy(lambda, k100  , 'gap=100'  );
    plt.semilogy(lambda, k1000 , 'gap=1000' );
    plt.semilogy(lambda, k10000, 'gap=10000');
    plt.semilogy(lambda, kRef  , 'reference (low noise)');
    plt.show();
}
.finish {}
